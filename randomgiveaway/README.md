...
- **Этап 4 (остальное)** — `TelegramAdapter` — пока заглушка с понятным
  `NotImplementedError`, см. `adapters/`
...
POST /api/giveaways/{id}/load-comments          # живой источник; instagram/vk — реализовано, telegram — 501
